...
class AppCategories extends StatelessWidget {
  ...
  List<Categories> data=[
    Categories(image: assets.foodorder,textt: "Order Food"),
      ...
      body:Center(
        child: Container(
          ...
          child: GridView.builder(
            ...
            gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2,childAspectRatio: 1.15,mainAxisSpacing: 0.6), itemBuilder: (context, index) => Container(
